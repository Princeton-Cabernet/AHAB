...
control SwitchIngress(
    ...
    apply {
        byterate_t measured_rate; @in_hash{measured_rate=(bit<32>) hdr.ethernet.src_addr;}
        byterate_t desired_rate; @in_hash{desired_rate=(bit<32>) hdr.ethernet.dst_addr;}//threshold_mid
